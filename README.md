# eBoard ST-LINK Interface PCB for STM32 Programming & Debugging
The eBoard_STLINK_Interface repository provides a custom-designed PCB that acts as a flexible bridge between ST-LINK programmers and STM32-based projects. It supports multiple ST-LINK variants (e.g., V2, V3, clone models) and standardizes their pinouts, making it easy to connect any programmer to your target board without hassle.
...
-  Once **Git Bash** is open, run the following command to clone the repository:
 ...
 ```bash
git clone https://github.com/aKaReZa75/eBoard_STLINK_Interface.git
```
